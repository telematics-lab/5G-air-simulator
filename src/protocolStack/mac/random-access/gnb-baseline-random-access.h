...
#ifndef GNB_BASELINE_RANDOM_ACCESS_H_
#define GNB_BASELINE_RANDOM_ACCESS_H_
...
class GnbBaselineRandomAccess : public GnbRandomAccess
{
...
public:
  ...
  GnbBaselineRandomAccess();
  GnbBaselineRandomAccess(MacEntity* mac);
  virtual ~GnbBaselineRandomAccess();

  void SetGnbBaselineRandomAccess();
  void GetGnbBaselineRandomAccess();
...
#endif /* GNB_BASELINE_RANDOM_ACCESS_H_ */
