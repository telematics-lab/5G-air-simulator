...
#ifndef UE_ENHANCED_RANDOM_ACCESS_H_
#define UE_ENHANCED_RANDOM_ACCESS_H_
...
class UeEnhancedRandomAccess : public UeRandomAccess
{
public:

  UeEnhancedRandomAccess();
  UeEnhancedRandomAccess(MacEntity* mac);
  virtual ~UeEnhancedRandomAccess();
...
#endif /* UE_ENHANCED_RANDOM_ACCESS_H_ */
